...
export default function NetworkBoxCameraPage() {
  const camera = {
    model: "CP-UNC-BE51E-VMD-Q",
    name: "5MP Network Box Camera",
    image: "/productmp2/hdcamera/ip5mp.svg",
    price: "₹8,500",
    specs: [
      '1/2.7" 5MP PS CMOS Image Sensor (0.9407 cm)',
      "Max. 5MP (2960 × 1668) @ 1–25/30 fps",
      "C/CS Mount Lens",
      "Instastream, H.265, H.264, H.264B, H.264H, MJPEG",
      "Support Quad Stream",
      "WDR (120 dB), Day/Night (ICR), 3D NR, ROI, Defog, AWB, AGC, BLC, HLC",
